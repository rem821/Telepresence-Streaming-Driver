...
class StreamConfiguration(Model):
    ...
    def __init__(self, ip_address: str=None, port: int=None, codec: str=None, bitrate: str=None, resolution: Apiv1streamupdateResolution=None, video_mode: str=None, fps: int=None):  # noqa: E501
        ...
        :type ip_address: str
        :param port: The port of this StreamConfiguration.  # noqa: E501
        :type port: int
    ...
    @property
    def port(self) -> int:
        """Gets the port of this StreamConfiguration.


        :return: The port of this StreamConfiguration.
        :rtype: int
        """
        return self._port
    ...
    def port(self, port: int):
        """Sets the port of this StreamConfiguration.


        :param port: The port of this StreamConfiguration.
        :type port: int
        """
